...
if(isset($_GET['loai']))
{ 
    $sanphams=$db->exeQuery("select masp, tensp,dongia,luotxem,hinh from sanpham where maloai=? limit $bd,".sanpham_1_TRANG,array($_GET['loai']));
}
else
{
    $sanphams=$db->exeQuery("select * from sanpham  limit 9");
